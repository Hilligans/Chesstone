...
import dev.hilligans.chesstone.board.movement.*;
...
public class BoardBuilder {
    ...
    public Piece getPieceForTeam(int pieceID, int team) {
        return switch (pieceID) {
            case 2 -> new Block(team);
            case 3 -> new RedstoneTorch(team);
            case 4 -> new TargetBlock(team);
            case 5 -> new Repeater(team);
            case 6 -> new Comparator(team);
            case 7 -> new Lamp(team);
            default -> null;
        };
    }
